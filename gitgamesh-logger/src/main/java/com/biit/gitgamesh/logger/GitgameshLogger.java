...
public class GitgameshLogger {
	...
	public static void errorMessage(Class<?> classWithError, Throwable throwable) {
		errorMessageNotification(logger, classWithError.getClass().getName(), getStackTrace(throwable));
	}
